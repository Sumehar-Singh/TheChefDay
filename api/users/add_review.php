...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ChefID'], $_POST['UserID'], $_POST['Rating'], $_POST['ReviewText'])) {
    ...
    $isBookingReview = isset($_POST['IsBookingReview']) ? $_POST['IsBookingReview'] : '0';

    // Step 1: Check for existing review (Only if NOT a booking review)
    $stmtProceed = true; // Default proceed

    if ($isBookingReview !== '1') {
        ...
        if ($checkStmt->num_rows > 0) {
            // Review already exists for general review
