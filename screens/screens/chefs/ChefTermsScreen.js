...
const ChefTermsScreen = ({ navigation }) => {
    ...
    const fetchTermDate = async () => {
            ...
            try {
              const response = await axios.get(`${BASE_URL}shared/get_term_date.php`, {
                params: { UserId: profile.Id, Role:'Chef' },
              });
 ...
 fetchTermDate();
  ...
  return (
    <SafeAreaView style={styles.container}>
      <CustomStatusBar title="Chef Terms & Conditions" includeTopInset={false} />
      ...
      <View style={styles.acceptanceContainer}>
        <View style={styles.acceptanceBadge}>
          ...
          <Text style={styles.acceptanceText}>Accepted on {
...
export default ChefTermsScreen;
