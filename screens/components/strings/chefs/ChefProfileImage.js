...
import localImage from '../../../../assets/userImage.jpg';

const ChefProfileImage = ({ userId, height = 100, width = 100,mr=0,ml=0 }) => {
  ...
  const getUserProfileImage = async (userId) => {
    try {
      const response = await axios.get(`${BASE_URL}chefs/strings/get_profileimage.php`, {
...
export default ChefProfileImage;
